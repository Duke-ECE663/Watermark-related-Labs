...
def main():
    ...
    for sigma in [0.05, 0.1, 0.2, 0.3]:
        ...
        print('FPR when sigma=', args.sigma, ':', np.sum(certified_fp >= args.tau, axis=1) / num_data)
    ...
    for sigma in [0.05, 0.1, 0.2, 0.3]:
        ...
        print('FNR when sigma=', args.sigma, ':', np.sum(certified_fn < args.tau, axis=1) / num_data)
